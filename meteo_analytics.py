...
def request_data(headers, data, station_number=75114001, date_begin='2024-01-01', date_end='2024-01-02'):
    """
    Requesting data from Meteo France API
    :param headers: API header, retrieved from get_headers_data
    :param data: API data , retrieved from get_headers_data
    :param station_number: string or int. Station number, default is Montsouris station
    :param date_begin: string "YYYY-MM-DD". Start date of the data. Default is 2024-01-01
    :param date_end: string "YYYY-MM-DD". End date of the data. Default is 2024-01-02
    :return: Request number. You will have to download the data using this number and download function
    """
    url_data = f"https://public-api.meteofrance.fr/public/DPClim/v1/commande-station/horaire?id-station={station_number}&date-deb-periode={date_begin}T00%3A00%3A00Z&date-fin-periode={date_end}T00%3A00%3A00Z"
...
if __name__ == "__main__":
    ...
    number = request_data(headers, data, station_number=75114001, date_begin='2024-01-01', date_end='2024-01-02')
